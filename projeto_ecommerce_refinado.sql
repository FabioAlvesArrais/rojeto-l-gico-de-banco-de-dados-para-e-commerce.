...
constraint fk_payments_cliente foreign key (idPClient) references clients (idClient),
constraint fk_payments_credicard foreign key (paycardNum) references creditCard (cardNumber)
);
